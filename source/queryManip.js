...
export class Conversation{
    ...
    enough_info_response = await enough_info_response;
    let enough_info_response_text = enough_info_response[0].generated_text;
    console.log(enough_info_response_text);

    if(enough_info_response.includes("YES") || enough_info_response.includes("yes")){
